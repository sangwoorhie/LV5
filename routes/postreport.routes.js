...
router.post('/:postId/report', Authmiddleware, postReportController.createReport) // 게시글 신고 생성
router.delete('/:postId/report', Authmiddleware, postReportController.deleteReport) // 게시글 신고 취소
