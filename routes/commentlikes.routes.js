...
router.post('/:postId/comments/:commentId/like', Authmiddleware, commentLikesController.createCommentLikes); // 댓글 좋아요 생성
router.delete('/:postId/comments/:commentId/like', Authmiddleware, commentLikesController.deleteCommentLikes); // 댓글 좋아요 삭제
